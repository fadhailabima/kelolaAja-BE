...
const parse_formdata_middleware_1 = require("../middlewares/parse-formdata.middleware");
const router = (0, express_1.Router)();
const controller = new job_application_controller_1.JobApplicationController();
router.post("/apply", upload_middleware_1.upload.single("cv"), upload_middleware_1.handleMulterError, parse_formdata_middleware_1.parseFormDataBody, (0, middlewares_1.validate)(job_posting_validator_1.createJobApplicationSchema), controller.create);
