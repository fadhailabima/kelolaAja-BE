...
async function main() {
  ...
  console.log('✅ Admin User created (email: admin@kelolaaja.com, password: admin123)\n');
        ...
        create: [
          {
            locale: 'id' as const,
            planName: 'Small',
            description: 'Alur Bisnis Lengkap, Manajemen Stok, Aset Tetap, Inventori Multi Gudang, Laporan Keuangan & Bisnis, Multi Cabang/Divisi/Outlet/Proyek, Pembatasan Hak Akses, File Attachment, Auto Backup, Free Support',
            userRange: '5-10 User',
          },
          {
            locale: 'en' as const,
            planName: 'Small',
            description: 'Complete Business Flow, Stock Management, Fixed Assets, Multi-Warehouse Inventory, Financial & Business Reports, Multi Branch/Division/Outlet/Project, Access Control, File Attachment, Auto Backup, Free Support',
  ...
  const testimonialsData = [
    {
      ...
      translations: {
        create: [
          ...
          {
            locale: 'en' as const,
            quote: 'Using KelolaAja ERP software that is simple, practical, and easy to use makes management faster and more efficient.',
          },
        ],
      },
    },
    {
      ...
      translations: {
        create: [
          ...
          {
            locale: 'en' as const,
            quote: 'KelolaAja is simple, practical, and easy to use, making management faster and more efficient and can be accessed anywhere.',
          },
        ],
      },
    },
      ...
      translations: {
        create: [
          ...
          },
          {
            ...
            description: 'Our consultant team will identify your business problems and needs',
          },
        ],
      },
    },
      ...
      translations: {
        create: [
          ...
          },
          {
            locale: 'en' as const,
            title: 'Planning',
            description: 'We ensure the system works according to your business process.',
          },
        ],
      },
    },
      ...
      translations: {
        create: [
          ...
          },
          {
            locale: 'en' as const,
            title: 'Training',
            description: 'Helping users through specialized training for each division.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Penjualan',
            description: 'Kelola seluruh proses penjualan secara terintegrasi, mulai dari penawaran, pesanan pelanggan, pengiriman, hingga penagihan dan penerimaan pembayaran.',
          },
          {
            locale: 'en' as const,
            title: 'Sales',
            description: 'Manage the entire sales process in an integrated manner, from quotations, customer orders, delivery, to billing and payment receipts.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Multi Gudang',
            description: 'Kelola stok dan pergerakan barang di berbagai lokasi gudang secara terpusat dan real-time.',
          },
          {
            locale: 'en' as const,
            title: 'Multi Warehouse',
            description: 'Manage stock and goods movement across various warehouse locations centrally and in real-time.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Dark Mode',
            description: 'Nikmati tampilan antarmuka yang lebih nyaman untuk penggunaan jangka panjang.',
          },
          {
            locale: 'en' as const,
            title: 'Dark Mode',
            description: 'Enjoy a more comfortable interface display for long-term use.',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Ekspor invoice penjualan ke berbagai format sesuai kebutuhan bisnis.',
          },
          {
            locale: 'en' as const,
            title: 'Multi Export Invoice',
            description: 'Export sales invoices to various formats according to business needs.',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Kelola proses persetujuan dokumen secara terkontrol sebelum transaksi diproses lebih lanjut.',
          },
          {
            locale: 'en' as const,
            title: 'Document Approval',
            description: 'Manage document approval processes in a controlled manner before transactions are processed further.',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Buat laporan keuangan seperti laba rugi, neraca, dan arus kas secara real-time. Pemantauan buku besar, serta utang dan piutang, menjadi lebih sederhana.',
          },
          {
            locale: 'en' as const,
            title: 'Finance & Accounting',
            description: 'Create financial reports such as profit and loss, balance sheet, and cash flow in real-time. Monitoring general ledger, accounts payable and receivable becomes simpler.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Manufaktur',
            description: 'KelolaAja proses manufaktur dengan mudah, hitung Harga Pokok Penjualan produk secara otomatis. Rencanakan produksi, Bill of Material, serta hitung biaya bahan baku dan overhead produksi pabrik secara otomatis.',
          },
          {
            locale: 'en' as const,
            title: 'Manufacturing',
            description: 'Manage manufacturing processes easily, calculate Cost of Goods Sold automatically. Plan production, Bill of Materials, and calculate raw material costs and factory overhead automatically.',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'KelolaAja dirancang untuk semua jenis & skala bisnis. Sekalipun Anda tidak memahami secara mendalam, Anda akan dengan mudah beradaptasi dengan KelolaAja.',
          },
          {
            locale: 'en' as const,
            title: 'Project Management',
            description: 'KelolaAja is designed for all types & scales of business. Even if you don\'t understand it deeply, you will easily adapt to KelolaAja.',
          },
        ],
      },
    },
      ...
      translations: {
        create: [
          ...
          },
          {
            ...
            description: 'More flexible buying and selling process, can choose outright sale or consignment. Equipped with down payment and tiered discount features. Monitor goods delivery, create invoices easily in one software.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'HR & Payroll',
            description: 'KelolaAja HR dan payroll dengan mudah, mulai dari pengelolaan data karyawan, absensi, hingga perhitungan gaji. Semua proses otomatis, akurat, dan dapat diakses kapan saja.',
          },
          {
            locale: 'en' as const,
            title: 'HR & Payroll',
            description: 'Manage HR and payroll easily, from employee data management, attendance, to salary calculation. All processes are automatic, accurate, and accessible anytime.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Visi Kami',
            description: 'Menjadi solusi ERP terdepan yang memberdayakan bisnis di Indonesia untuk tumbuh dan berkembang dengan teknologi yang mudah digunakan.',
          },
          {
            locale: 'en' as const,
            title: 'Our Vision',
            description: 'To become the leading ERP solution that empowers businesses in Indonesia to grow and develop with easy-to-use technology.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Misi Kami',
            description: 'Menyediakan sistem ERP yang komprehensif, terjangkau, dan mudah digunakan untuk semua skala bisnis.',
          },
          {
            locale: 'en' as const,
            title: 'Our Mission',
            description: 'Providing comprehensive, affordable, and easy-to-use ERP systems for all business scales.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Nilai Kami',
            description: 'Inovasi, Integritas, dan Kepuasan Pelanggan adalah nilai utama yang kami pegang dalam setiap layanan.',
          },
          {
            locale: 'en' as const,
            title: 'Our Values',
            description: 'Innovation, Integrity, and Customer Satisfaction are the core values we uphold in every service.',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Interface yang intuitif dan user-friendly membuat siapa saja bisa menggunakan sistem dengan mudah.',
          },
          {
            locale: 'en' as const,
            title: 'Easy to Use',
            description: 'Intuitive and user-friendly interface makes it easy for anyone to use the system.',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Pantau bisnis Anda secara real-time dengan data yang selalu update.',
          },
          {
            locale: 'en' as const,
            title: 'Real-time Data',
            description: 'Monitor your business in real-time with always updated data.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Cloud-Based',
            description: 'Akses dari mana saja, kapan saja dengan sistem berbasis cloud yang aman.',
          },
          {
            locale: 'en' as const,
            title: 'Cloud-Based',
            description: 'Access from anywhere, anytime with a secure cloud-based system.',
          },
        ],
      },
    },
        ...
        create: [
          {
            locale: 'id' as const,
            title: 'Multi User',
            description: 'Kolaborasi tim dengan akses multi-user dan pengaturan hak akses yang fleksibel.',
          },
          {
            locale: 'en' as const,
            title: 'Multi User',
            description: 'Team collaboration with multi-user access and flexible permission settings.',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Data bisnis Anda dilindungi dengan enkripsi dan backup otomatis.',
          },
          {
            locale: 'en' as const,
            title: 'Secure',
            description: 'Your business data is protected with encryption and automatic backup.',
          },
        ],
      },
    },
  ...
  const faqsData = [
    {
      ...
      translations: {
        create: [
          ...
          {
            locale: 'en' as const,
            question: 'What differentiates KelolaAja from other ERP software in the market?',
            answer: 'KelolaAja presents a balance between system quality, feature depth, and cost affordability. Compared to local and global ERPs, KelolaAja offers comprehensive and cost-efficient solutions without sacrificing core functionality.',
          },
        ],
      },
    },
    {
      ...
      translations: {
        create: [
          ...
          {
            locale: 'en' as const,
            question: 'Do users need to have technical experience to use KelolaAja?',
            answer: 'No. KelolaAja is designed with an intuitive interface and simplified workflow based on direct research into business user needs at various levels. This system can be used without prior technical experience.',
          },
        ],
      },
    },
      ...
      translations: {
        create: [
          ...
          },
          {
            ...
            answer: 'KelolaAja has been designed to directly support common business processes without customization. If there are very specific needs, customization is possible with additional costs according to complexity. However, we do not recommend customization unless absolutely necessary, to keep the system efficient, stable, and scalable.',
          },
        ],
      },
    },
      ...
      translations: {
        create: [
          ...
          },
          {
            ...
            answer: 'Nothing. You only need a computer and an internet connection.',
          },
        ],
      },
    },
      ...
      translations: {
        create: [
          ...
          },
          {
            ...
            answer: 'KelolaAja ERP accounting can save company work time. In addition, this accounting system can also prevent your company from errors or mistakes in accounting calculations, making business reports safer, faster and easier.',
          },
        ],
      },
    },
      ...
      translations: {
        create: [
          ...
          },
          {
            ...
            answer: 'KelolaAja takes customer security seriously. In addition, the excellence of software, systems, and data is our top priority. Security is also the key to our offering. Therefore, all information you provide has been encrypted and secured with leading technology and security.',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Sistem akuntansi lengkap dengan jurnal, buku besar, dan laporan keuangan',
          },
          {
            locale: 'en' as const,
            featureName: 'Accounting',
            description: 'Complete accounting system with journal, general ledger, and financial reports',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Manajemen stok barang dengan multi gudang dan tracking real-time',
          },
          {
            locale: 'en' as const,
            featureName: 'Inventory',
            description: 'Stock management with multi-warehouse and real-time tracking',
          },
        ],
      },
    },
        ...
        create: [
          {
            ...
            description: 'Kelola proses penjualan dari quotation hingga invoice',
          },
          {
            locale: 'en' as const,
            featureName: 'Sales',
        ...
        create: [
          {
            ...
            description: 'Manajemen pembelian dan vendor dengan PO dan invoice',
          },
          {
            locale: 'en' as const,
  ...
  const mediaFilesData = [
    ...
    { fileName: 'about-us.jpg', filePath: 'public/images/company-profile/about-us.jpg', storageUrl: '/images/company-profile/about-us.jpg', fileType: 'image/jpeg', mimeType: 'image/jpeg' },
    { fileName: 'vision.jpg', filePath: 'public/images/company-profile/vision.jpg', storageUrl: '/images/company-profile/vision.jpg', fileType: 'image/jpeg', mimeType: 'image/jpeg' },
    { fileName: 'mission.jpg', filePath: 'public/images/company-profile/mission.jpg', storageUrl: '/images/company-profile/mission.jpg', fileType: 'image/jpeg', mimeType: 'image/jpeg' },

    // Sales
    { fileName: 'sales.png', filePath: 'public/images/sales/sales.png', storageUrl: '/images/sales/sales.png', fileType: 'image/png', mimeType: 'image/png' },
    { fileName: 'sales2.png', filePath: 'public/images/sales/sales2.png', storageUrl: '/images/sales/sales2.png', fileType: 'image/png', mimeType: 'image/png' },
    { fileName: 'feature-sales.jpg', filePath: 'public/images/sales/feature-sales.jpg', storageUrl: '/images/sales/feature-sales.jpg', fileType: 'image/jpeg', mimeType: 'image/jpeg' },

    // Industries
    { fileName: 'retail.png', filePath: 'public/images/industries/retail/retail.png', storageUrl: '/images/industries/retail/retail.png', fileType: 'image/png', mimeType: 'image/png' },
    { fileName: 'kontraktor.png', filePath: 'public/images/industries/contractor/kontraktor.png', storageUrl: '/images/industries/contractor/kontraktor.png', fileType: 'image/png', mimeType: 'image/png' },

    // Benefits
    { fileName: 'multi-export.png', filePath: 'public/images/benefits/multi-export.png', storageUrl: '/images/benefits/multi-export.png', fileType: 'image/png', mimeType: 'image/png' },
        ...
        create: [
          {
            ...
            heroDescription: 'Buat laporan keuangan seperti laba rugi, neraca, dan arus kas secara real-time. Pemantauan buku besar, serta utang dan piutang, menjadi lebih sederhana.',
            aboutTitle: 'Kenapa Memilih Modul Akuntansi Kami?',
            aboutDescription1: 'Kami menyediakan fitur akuntansi yang dirancang khusus untuk kebutuhan bisnis Indonesia, sesuai dengan standar PSAK namun tetap mudah digunakan oleh orang awam.',
          },
          {
            locale: 'en' as const,
            heroTitle: 'Complete Accounting System',
            heroSubtitle: 'Manage business finances easily and accurately',
            heroDescription: 'Create financial reports such as profit and loss, balance sheet, and cash flow in real-time. Monitoring general ledger, as well as accounts payable and receivable, becomes simpler.',
            aboutTitle: 'Why Choose Our Accounting Module?',
            aboutDescription1: 'We provide accounting features designed specifically for Indonesian business needs, compliant with PSAK standards but still easy to use for laypeople.',
          }
        ]
      }
    },
        ...
        create: [
          {
            ...
            heroSubtitle: 'Pantau stok barang di berbagai gudang secara real-time',
            heroDescription: 'Kelola produk dan inventory dengan efisien, mulai dari pengadaan hingga pengiriman. Pantau stok secara real-time, atur harga, dan optimalkan alur distribusi.',
            aboutTitle: 'Kontrol Penuh Atas Produk Anda',
            aboutDescription1: 'Hindari kehabisan stok atau penumpukan barang mati. Sistem kami membantu Anda merencanakan pengadaan dengan lebih cerdas.',
          },
          {
            locale: 'en' as const,
            heroTitle: 'Stock & Inventory Management',
            heroSubtitle: 'Monitor stock across multiple warehouses in real-time',
            heroDescription: 'Manage products and inventory efficiently, from procurement to delivery. Monitor stock in real-time, set prices, and optimize distribution flows.',
            aboutTitle: 'Full Control Over Your Products',
            aboutDescription1: 'Avoid stockouts or dead stock accumulation. Our system helps you plan procurement smarter.',
          }
        ]
      }
    },
        ...
        create: [
          {
            ...
            heroSubtitle: 'Tingkatkan omset dengan proses penjualan yang cepat',
            heroDescription: 'Proses jual-beli yang lebih fleksibel, bisa pilih jual putus atau konsinyasi. Dilengkapi fitur DP dan diskon bertingkat. Pantau pengiriman barang dan buat tagihan dengan mudah.',
            aboutTitle: 'Permudah Tim Sales Anda',
            aboutDescription1: 'Berikan alat yang tepat bagi tim penjualan untuk mencatat pesanan, mengecek stok, dan menagih pembayaran dalam satu platform.',
          },
          {
            locale: 'en' as const,
            heroTitle: 'Sales App & POS',
            heroSubtitle: 'Increase turnover with fast sales processes',
            heroDescription: 'More flexible buying and selling processes, choose between direct sales or consignment. Equipped with DP and tiered discount features. Monitor shipments and create invoices easily.',
            aboutTitle: 'Empower Your Sales Team',
            aboutDescription1: 'Give your sales team the right tools to record orders, check stock, and collect payments in one platform.',
          }
        ]
      }
    },
        ...
        create: [
          {
            ...
            heroDescription: 'Otomatisasi proses pembelian dari PR (Purchase Request) hingga PO (Purchase Order). Bandingkan harga vendor dan dapatkan penawaran terbaik.',
            aboutTitle: 'Efisiensi Biaya Pengadaan',
            aboutDescription1: 'Kontrol pengeluaran perusahaan dengan sistem approval berjenjang untuk setiap pembelian.',
          },
          {
            locale: 'en' as const,
            heroTitle: 'Purchasing System',
            heroSubtitle: 'Manage vendors and procurement more efficiently',
            heroDescription: 'Automate purchasing processes from PR (Purchase Request) to PO (Purchase Order). Compare vendor prices and get the best deals.',
            aboutTitle: 'Procurement Cost Efficiency',
            aboutDescription1: 'Control company expenses with tiered approval systems for every purchase.',
          }
        ]
      }
    },
        ...
        create: [
          {
            ...
            heroDescription: 'Kelola HR dan payroll dengan mudah, mulai dari pengelolaan data karyawan, absensi, hingga perhitungan gaji. Semua proses otomatis, akurat, dan aman.',
            aboutTitle: 'Aset Terbesar Adalah Karyawan',
            aboutDescription1: 'Pastikan hak karyawan terpenuhi tepat waktu dengan perhitungan gaji, PPh 21, dan BPJS yang akurat.',
          },
          {
            locale: 'en' as const,
            heroTitle: 'Automated HRIS & Payroll',
            heroSubtitle: 'Manage employees and payroll without hassle',
            heroDescription: 'Manage HR and payroll easily, from employee data management, attendance, to salary calculation. All processes are automatic, accurate, and secure.',
            aboutTitle: 'Employees Are The Biggest Asset',
            aboutDescription1: 'Ensure employee rights are met on time with accurate salary, PPh 21, and BPJS calculations.',
          }
        ]
      }
    }
  ...
  console.log('🎉 Database seeding completed successfully!\n');
  console.log('📊 Summary:');
  console.log('  - 1 Admin User (email: admin@kelolaaja.com, password: admin123)');
